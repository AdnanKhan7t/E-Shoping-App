...
import com.MetroEnterprises.shopping.Model.AdminOrders;
...
public class AdminNewOrdersActivity extends AppCompatActivity {
        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull final AdminOrders model) {
                        holder.userQuantity.setText("quantity  "+model.getQuantity());
    ...
    public static class AdminOrdersViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView userName,userQuantity, userPhoneNumber,userTotalPrice,userDateTime,userShippingAddress;
        public Button showOrdersBtn;
        public AdminOrdersViewHolder(View itemView) {
            super(itemView);
            userQuantity= itemView.findViewById(R.id.order_Quantity);
