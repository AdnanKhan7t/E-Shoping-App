            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    //    txtTotalAmount.setText("TDear "+userName+"\n order is shipped successfully.");
                        ...
                        Toast.makeText(CartActivity.this,"Now, you can purchase more products",Toast.LENGTH_SHORT).show();
                    }
                    else if (shippingState.equals("Not Shipped")){
                        txtTotalAmount.setText("Shipping State = Not Shipped");
                        recyclerView.setVisibility(View.GONE);
                        txtMsg1.setVisibility(View.VISIBLE);
                        txtMsg1.setText("Your Final order will be shipped successfully. Soon you will received your order at your door step.");
